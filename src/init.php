...
function colored_stripe_block_cgb_block_assets() { // phpcs:ignore
  ...
  wp_register_style(
    'colored_stripe_block-cgb-style-css', // Handle.
  ...
  wp_register_script(
    'colored_stripe_block-cgb-block-js', // Handle.
  ...
  wp_register_style(
    'colored_stripe_block-cgb-block-editor-css', // Handle.
   ...
   */
  register_block_type(
    'cgb/block-colored-stripe-block', array(
      // Enqueue blocks.style.build.css on both frontend & backend.
      'style'         => 'colored_stripe_block-cgb-style-css',
...
// Hook: Block assets.
add_action( 'init', 'colored_stripe_block_cgb_block_assets' );
